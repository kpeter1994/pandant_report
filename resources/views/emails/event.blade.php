...
<body style="word-spacing:normal;">
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"><!-- TODO Add mail preview --></div>
                            ...
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;font-style:bold;line-height:1;text-align:left;color:#000000;">{{$trafficEvent->bus->license_plate}} forgalmi esemény értesítő</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">{{$trafficEvent->event_time}}</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                                    <tr>
                                      <td><b>Rendszám:</b></td>
                                      <td>{{$trafficEvent->bus->license_plate}} </td>
                                    </tr>
                                    <tr>
                                      <td><b>Időpont:</b></td>
                                      <td>{{$trafficEvent->event_time}} </td>
                                    </tr>
                                    <tr>
                                      <td><b>Telephely:</b></td>
                                      <td>{{$trafficEvent->bus->site->name}}</td>
                                    </tr>
                                      <tr>
                                          <td><b>Eseményt rögzítő:</b></td>
                                          <td>{{$trafficEvent->user->name}}</td>
                                      </tr>
                                      <tr>
                                          <td><b>Felelősség:</b></td>
                                          <td>
                                              @if($trafficEvent->alien_fault)
                                                    Idegen hibás
                                              @else
                                                    Saját hibás
                                              @endif
                                      ...
                                      @if($trafficEvent->damage_value)
                                          <tr>
                                              <td><b>Kárérték:</b></td>
                                              <td>{{$trafficEvent->damage_value}} Ft</td>
                                          </tr>
                                      @endif
                                          <tr>
                                              <td><b>Személyi sérült:</b></td>
                                              <td>
                                                  @if($trafficEvent->personal_injury > 0)
                                                      {{$trafficEvent->personal_injury}} fő
                                                    @else
                                                      Nincs
                                                  @endif
                                              </td>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">{{$trafficEvent->description}}</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
