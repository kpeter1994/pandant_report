            ...
            <tr>
                <td style="direction:ltr;font-size:0px;padding:;text-align:center;">
                        ...
                        <tr>
                            <td class="" width="600px">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" class=""
                                       role="presentation" style="width:600px;" width="600" bgcolor="#DEDEDE">
                                    <tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div
                                                        style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;font-style:bold;line-height:1;text-align:left;color:#000000;">
                                                        Napi üzemviteli jelentés
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                        <div
                                                            style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:bold;line-height:1;text-align:left;color:#000000;">{{$key}}</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                            ...
                                                            <tr>
                                                                <td>Teljes autóbusz állomány (db)</td>
                                                                @foreach($demands as $demand)
                                                                    <td>{{$demand->stock}}</td>
                                                                @endforeach
                                                            </tr>
                                                            <tr>
                                                                <td>Napi autóbusz forgalmi igény (db)</td>
                                                                @foreach($demands as $demand)
                                                                    <td>{{$demand->got}}</td>
                                                                @endforeach
                                                            </tr>
                                                            <tr>
                                                                <td>Üzem által kiadott mennyiség (db)</td>
                                                                @foreach($demands as $demand)
                                                                    <td>{{$demand->garden}}</td>
                                                                @endforeach
                                                            </tr>
                                                            <tr>
                                                                <td>Javító darabszám (db)</td>
                                                                @foreach($demands as $demand)
                                                                    <td>{{$demand->stock - $demand->garden}}</td>
                                                                @endforeach
                                                            </tr>
                                                            <tr>
                                                                <td>Forgalomképes tartalék darabszám (db)</td>
                                                                @foreach($demands as $demand)
                                                                    <td>{{$demand->garden - $demand->got}}</td>
                                                                @endforeach
                                                            </tr>
                                                        </table>
                                                    </td>
                    ...
                    <tr>
                        <td class="" width="600px">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" class=""
                                   role="presentation" style="width:600px;" width="600" bgcolor="#F0F0F0">
                                <tr>
                                    <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                                ...
                                <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                                    ...
                                    <div class="mj-column-per-100 mj-outlook-group-fix"
                                        ...
                                        @foreach($report->trafficEvents as $event)
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                   style="vertical-align:top; {{$extraStyle}}" width="100%">
                                                <tbody>
                                                <tr>
                                                    <td align="left"
                                                        style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                            ...
                                                            @if($event->damage_value > 0)
                                                                <tr>
                                                                    <td><b>Kárérték:</b></td>
                                                                    <td>{{ number_format($event->damage_value, 0, ',', ' ') }}
                                                                        Ft
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                        <div
                                                            style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">{{$event->description}}</div>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <div
                                                            style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;">
                                                            <b>Tartósan javító autóbusz</b></div>
                                                    </td>
                                                </tr>
                                                @foreach($buses as $bus)
                                                    @foreach($bus->serviceWorksheets as $worksheet)
